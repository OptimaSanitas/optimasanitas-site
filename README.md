...
- **`https://optimasanitas.github.io/optimasanitas-site/`** — GitHub Pages mirror (engineering only)

**Apps, MWA identity, and dApp Store listings must use `https://optimasanitas.com` only** — not SNS/Sol.site aliases.
